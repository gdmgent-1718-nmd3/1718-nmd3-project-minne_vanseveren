...
4. ![gebruikerstesten smartphone 4]({{ '/images/gebruikt_sp_4.png' | relative_url }}){:style="width: 20%"}<br>Wanneer je werken aan je route hebt toegevoegd, kun je dit weergeven aan de hand van dit scherm. I.p.v. volgende hal kunnen we naar overzicht plaatsen. Om vervolgens terug op dit scherm terecht te komen. Op de overzichtspagina vind je een knop mijn route om naar de kaart te gaan.<br>
